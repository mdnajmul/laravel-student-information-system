...
$(document).on('click','.category_status',function(){
	...
	$.get(BASE_URL+'/admin/category_status/'+id,function(val){
...
$(document).on('click','.exam_status',function(){
	var id=$(this).attr('data-id');
	$.get(BASE_URL+'/admin/exam_status/'+id,function(val){
		alert('Status Successfully Changed!');
	});
});
...
$(document).on('click','.student_status',function(){
	var id=$(this).attr('data-id');
	$.get(BASE_URL+'/admin/student_status/'+id,function(val){
		alert('Status Successfully Changed!');
	});
});
...
$(document).on('click','.portal_status',function(){
	var id=$(this).attr('data-id');
	$.get(BASE_URL+'/admin/portal_status/'+id,function(val){
		alert('Status Successfully Changed!');
	});
});